...
export const Crest = ({ className, variant }: CrestProps) => {
    switch (variant) {
        case "gold":
            return (
                <svg className={cn("", className)} viewBox="0 0 365 468" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        default:
            return (
                <svg className={cn("", className)} viewBox="0 0 211 280" fill="none" xmlns="http://www.w3.org/2000/svg">
